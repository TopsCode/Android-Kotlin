...
class MainActivity : AppCompatActivity(), View.OnClickListener {
    ...
    open fun getPath(uri: Uri?): String? {
        ...
        cursor!!.moveToFirst()
        val path: String = cursor.getString(cursor.getColumnIndex(MediaStore.Video.Media.DATA))
        cursor.close()
        return path
    }
    ...
    override fun onClick(p0: View?)
    {
        ...
        if(p0==button2)
        {
            ...
            try
            {
                MultipartUploadRequest(this@MainActivity,"https://vyasprakruti.000webhostapp.com/demo/upload.php")
